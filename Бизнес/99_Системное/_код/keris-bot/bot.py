...
ABOUT_TEXT = (
    "🐾 <b>Keris Club</b> — это авторский питомник Teddy Maltipoo F1.\n\n"
    ...
    "🤍 Будем рады познакомиться с вами и помочь найти вашего малыша."
)

PRICE_TEXT = (
    "💰 <b>Стоимость и условия бронирования</b>\n\n"
    "Стоимость щенков начинается от 250 000 ₽ и зависит от размера "
    "(стандарт, мини или микро) и экстерьера.\n\n"
    "📌 Бронирование — 30% от стоимости по договору. С этого момента щенок "
    "закрепляется за вашей семьёй.\n\n"
    "💳 Беспроцентная рассрочка предоставляется через банк на срок "
    "от 3 до 6 месяцев.\n\n"
    "💌 " + manager_link(
        "Напишите нам",
        "Здравствуйте! Пишу из бота Keris Club — интересует стоимость щенка.",
    ) + " — с удовольствием расскажем о понравившемся малыше, его стоимости "
    "и поможем подобрать щенка, который подойдёт именно вам."
)

PUPPY_CTA = (
    "\n\nВаше знакомство может начаться прямо сейчас. "
    + manager_link(
        "Напишите нам",
        "Здравствуйте! Пишу из бота Keris Club — хочу узнать о щенке.",
    )
    + " — с радостью расскажем о понравившемся щенке. 🐾"
)
...
# ── Обработчики ─────────────────────────────────────────────────────────────
GREETING = (
    "🐾 Рады приветствовать вас в <b>Keris Club</b>!\n\n"
