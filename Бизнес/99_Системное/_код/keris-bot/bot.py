...
ABOUT_TEXT = (
    ...
    "семьи, а не просто продаём щенков. Фирменные окрасы <b>ice gold, "
    "gold, gold brown</b> встречаются редко и всегда узнаваемы.\n\n"
    "Каждый малыш уезжает к вам с документами, ветпаспортом и договором — "
    "уже приучённым к пелёнке.\n\n"
    "📍 Москва — личное знакомство, или онлайн, если вы далеко\n"
...
PRICE_TEXT = (
    ...
    "Стоимость щенка зависит от окраса, размера и родословной — фирменный "
    "<b>ice gold</b> и микро-размер ценятся особенно.\n\n"
    ...
    + manager_link(
        "Напишите менеджеру",
        "Здравствуйте! Пишу из бота Keris Club — хочу узнать стоимость щенка.",
