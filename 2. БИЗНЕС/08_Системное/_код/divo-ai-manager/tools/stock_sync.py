...
def autoteka_field(d: dict) -> str:
    ...
    return (
        "ссылка в CME не стоит. Это не значит, что отчёта не существует. "
...
def card(
    ...
    if vat_total:
        ...
        lines.append(
            "- Цены в CME нет, цифру с НДС не выдумывай. "
...
def build_stock(
    ...
    head = [
        ...
        "> Формула одна на все машины, флаг НДС в CME не нужен. Нет цены ни в",
        ...
        "> «ссылка в CME не стоит» значит не говори клиенту, что автотеки не существует.",
        "",
    ]
