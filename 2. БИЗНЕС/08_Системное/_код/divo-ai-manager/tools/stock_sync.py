...
def build_stock(
    ...
    head = [
        ...
        "> Наши машины выкуплены. Спросили «она в лизинге была?» про нашу машину:",
        "> «нет, выкуплена». Без отчёта и без «на сделке покажем», пока клиент",
        "> сам не ткнул в автотеку или срок. Тогда: «в базах может отображаться,",
        "> по факту закрыт, на сделке покажем».",
