...
- `JOBS_ENABLED=false`: джобы 00:00 и 20:00 в расписание не ставятся. Код готов, включение — смена флага.
...
- **Имя в отчёте бота:** берём последний хэштег, которым человек уже подписывался в группе. Спрашиваем «как подписывать» только у тех, кто в группу с `#` ещё не писал.
