...
def pairs() -> list[tuple[str, str]]:
    ...
    out.append(("Личное/1. Профиль/", "Личное/"))
    out.append(("Личное/1.%20Профиль/", "Личное/"))

    for old_s, new_s in RAZUM_3DOT_TO_DD_DOT:
        oe, ne = old_s.replace(" ", "%20"), new_s.replace(" ", "%20")
        out.append((f"Личное/3. Разум/{old_s}", f"Личное/3. Разум/{new_s}"))
    ...
    for old_s, new_s in RAZUM_OLD_NEW:
        oe, ne = old_s.replace(" ", "%20"), new_s.replace(" ", "%20")
        out.append((f"Личное/2. Профиль/3. Разум/{old_s}", f"Личное/3. Разум/{new_s}"))
