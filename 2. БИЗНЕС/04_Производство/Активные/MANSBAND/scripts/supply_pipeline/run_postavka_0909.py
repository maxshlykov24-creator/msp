#!/usr/bin/env python3
"""Пайплайн Поставка 09.09 → flat / Прогон / Блокеры / (опц.) МС."""
...
DEFAULT_XLSX = (
    ...
    / "поставки"
    / "2026-09-09_Поставка-для-внесения.xlsx"
)

config.set_run(
    flat="Поставка 09.09 flat",
    run="Прогон 09.09",
    block="Блокеры 09.09",
    external_code="postavka-2026-09-09",
    description="Поставка 09.09",
    moment="2026-09-09 12:00:00.000",
)

import run_postavka_1507 as runner  # noqa: E402

# Бренд Emilio Renza уже в справочнике. Новая модель — как X1PR22TR6D6.
NEW_BRANDS: list = []
NEW_MODELS = [
    ("X1PR62D6", "X1PR62D6"),
]
...
def ensure_spr_abbrs(svc) -> None:
    """Дописать X1PR62D6 в Справочник, если нет."""
