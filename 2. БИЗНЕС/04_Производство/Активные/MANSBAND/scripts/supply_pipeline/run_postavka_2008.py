#!/usr/bin/env python3
"""Пайплайн Поставка 20.08 → flat / Прогон / Блокеры / (опц.) МС."""
...
DEFAULT_XLSX = (
    ...
    / "поставки"
    / "2026-08-20_Поставка-для-внесения.xlsx"
)

config.set_run(
    flat="Поставка 20.08 flat",
    run="Прогон 20.08",
    block="Блокеры 20.08",
    external_code="postavka-2026-08-20",
    description="Поставка 20.08",
