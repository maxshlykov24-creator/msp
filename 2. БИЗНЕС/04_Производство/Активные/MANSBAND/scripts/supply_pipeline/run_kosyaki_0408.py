#!/usr/bin/env python3
"""Пайплайн Косяки 04.08 → flat / Прогон / Блокеры / (опц.) МС."""
...
DEFAULT_XLSX = (
    ...
    / "поставки"
    / "2026-08-04_Косяки-для-внесения.xlsx"
)

config.set_run(
    flat="Косяки 04.08 flat",
    run="Прогон косяки 04.08",
    block="Блокеры косяки 04.08",
    external_code="kosyaki-2026-08-04",
    description="Косяки 04.08",
    moment="2026-08-04 12:00:00.000",
)
