...
const schema = z.object({
  ...
  // Период сверки остатков с МойСклад, мин (полная перезапись зеркала МС → сервер).
  // Между сверками остаток корректен за счёт оптимистичного списания при продаже.
  // С 29.07 синкаем 7 складов вместо 2 — интервал увеличен, иначе выгрузка не успевает.
  STOCK_SYNC_INTERVAL_MIN: z.coerce.number().default(60),
