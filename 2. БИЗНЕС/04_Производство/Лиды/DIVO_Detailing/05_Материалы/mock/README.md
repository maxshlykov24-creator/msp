...
Исходник трёх экранов для презентации. Данные **выдуманные**, реальных показателей DIVO Motors здесь нет и быть не должно.
...
| `mock.html?s=3` | Панель показателей: источник оплаченного заказа, загрузка мастеров, причины отказа | слайд 7 |
