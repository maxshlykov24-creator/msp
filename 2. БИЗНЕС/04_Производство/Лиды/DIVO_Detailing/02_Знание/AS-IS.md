...
Цена собирается из работы мастера, материалов и поста. На созвоне пример по химчистке: 5 000 работа мастера, 5 000 материалы, 2 000 моечный пост, итого 12 000, при сложном загрязнении до 20–25 000. Оклейка локально 70–200 000, только передняя часть 85 000.

Прайс получен 2026-09-21: [`ПРАЙС.md`](ПРАЙС.md). В каталоге другие якоря: полная химчистка 25 000, детейлинг уборка 10 000, оклейка зон риска 60 000, кузов полностью 200 000, керамика на ЛКП 20 000. В amoCRM идут строки прайса. Устные вилки с созвона не подставляем.
...
2. Состав прайса получен 2026-09-21, 58 позиций: [`ПРАЙС.md`](ПРАЙС.md). На созвоне названы покрас, сложные вмятины и полировка стекла — в скринах этих строк нет.
