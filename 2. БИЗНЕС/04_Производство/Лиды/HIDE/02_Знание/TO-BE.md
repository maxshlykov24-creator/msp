...
- **Шаблоны дел по направлениям:** оценка недвижимости всегда разворачивается в один и тот же набор шагов с закреплёнными ролями, залог доли — в свой. Единые правила работы компании.
...
Отдельное обещание, а не строчка в списке. У Дарины прямой страх заливать данные наружу, и он обоснован: в делах суммы, доли компаний, судебные споры. Подключение ИИ к системе подаётся как контролируемый доступ с правами и журналом обращений, а состав передаваемого согласуется письменно.
